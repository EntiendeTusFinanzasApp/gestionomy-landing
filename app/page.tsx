              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Una aplicación completa para el control de ingresos, gastos,
                    inventario y más. Todo lo que necesitas para tu negocio en
                    un solo lugar.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl">
                  Nuestra aplicación ofrece todas las herramientas que necesitas
                  para gestionar tus finanzas e inventario de manera eficiente.
                </p>
              </div>
            </div>
              ...
              >
                <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
                  <div className="flex flex-col justify-center space-y-4">
                    ...
                    <p className="text-muted-foreground">
                      El dashboard te ofrece una visión general de tus finanzas
                      e inventario con tarjetas de resumen que muestran la
                  ...
                  <div className="flex flex-col justify-center space-y-4">
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-center gap-2">
                        ...
                        <span>Ajusta cantidades, precios y ubicación de tus productos cuando quieras</span>
                      </li>
                      <li className="flex items-center gap-2">
                  ...
                  <div className="flex flex-col justify-center space-y-4">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2">
                        <ShoppingCart className="h-5 w-5 text-primary" />
                        <span>
                          Carga de ventas con múltiples productos de tu almacen
                        </span>
                      </li>
                      <li className="flex items-center gap-2">
                        <Package className="h-5 w-5 text-primary" />
                      ...
                      <li className="flex items-center gap-2">
                        ...
                        <span>Registro de pagos a proveedores y maestro de clientes</span>
                      </li>
                      <li className="flex items-center gap-2">
                        <LineChart className="h-5 w-5 text-primary" />
              ...
              >
                <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
                  <div className="flex flex-col justify-center space-y-4">
                    ...
                    <p className="text-muted-foreground">
                      Obtén informes detallados sobre tus finanzas, inventario y
                      ventas, con gráficos interactivos y diversos filtros.
                    </p>
                    <ul className="space-y-2">
                      <li className="flex items-center gap-2">
                        <BarChart3 className="h-5 w-5 text-primary" />
                      ...
                      <li className="flex items-center gap-2">
                        <FileBarChart className="h-5 w-5 text-primary" />
                        <span>Analiza por almacen, producto, cliente y categoría</span>
                      </li>
                    </ul>
                  </div>
                  <ImageCarousel
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl">
                  Agenda una reunión hoy mismo y descubre
                  cómo puede ayudarte a gestionar tus finanzas e inventario de
                  manera eficiente.
                </p>
              </div>
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
